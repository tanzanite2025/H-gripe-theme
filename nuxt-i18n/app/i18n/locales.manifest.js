export const locales = [
  ...
  { code: 'be', iso: 'be-BY', name: 'Беларуская', file: 'be.json' },
  { code: 'tr', iso: 'tr-TR', name: 'Türkçe', file: 'tr.json' },
  { code: 'bn', iso: 'bn-BD', name: 'বাংলা', file: 'bn.json' },
  ...
  { code: 'ur', iso: 'ur-PK', name: 'اردو', file: 'ur.json', dir: 'rtl' },
  { code: 'mr', iso: 'mr-IN', name: 'मराठी', file: 'mr.json' },
  { code: 'pcm', iso: 'pcm-NG', name: 'Nigerian Pidgin', file: 'pcm.json' },
  { code: 'fil', iso: 'fil-PH', name: 'Filipino', file: 'fil.json' },
  { code: 'te', iso: 'te-IN', name: 'తెలుగు', file: 'te.json' },
  { code: 'ha', iso: 'ha-NG', name: 'Hausa', file: 'ha.json' },
  { code: 'ps', iso: 'ps-AF', name: 'پښتو', file: 'ps.json', dir: 'rtl' },
  { code: 'sw', iso: 'sw-KE', name: 'Kiswahili', file: 'sw.json' },
  { code: 'tl', iso: 'tl-PH', name: 'Tagalog', file: 'tl.json' },
  { code: 'ta', iso: 'ta-IN', name: 'தமிழ்', file: 'ta.json' },
  { code: 'jv', iso: 'jv-ID', name: 'Basa Jawa', file: 'jv.json' },
