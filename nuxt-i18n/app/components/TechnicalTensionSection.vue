  ...
  <div class="space-y-8">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
      ...
      <ul class="space-y-3 text-sm tz-text-secondary">
       ...
       <div class="rounded-2xl bg-[#11151e] shadow-[0_4px_16px_rgba(0,0,0,0.5)] p-5 md:p-6 hover:translate-y-[-2px] transition-transform duration-300">
          ...
          <span class="tz-text-muted text-xs">High stiffness Focus. 120-130kgf (Drive Side).</span>
              </div>
          ...
          <span class="tz-text-muted text-xs">Durability Focus. Slightly lower tension for compliance and impact absorption.</span>
              </div>
          ...
          <span class="tz-text-muted text-xs">Reliability Focus. Moderate tension, thicker spokes.</span>
              </div>
           </div>
       </div>
    </div>
    ...
    <div class="rounded-2xl bg-[#11151e] shadow-[0_4px_16px_rgba(0,0,0,0.5)] overflow-hidden">
       ...
       <div class="overflow-x-auto">
        <table class="min-w-full text-left text-sm tz-text-secondary">
          <thead class="bg-slate-800/30 font-semibold tz-text-primary">
              <tr>
