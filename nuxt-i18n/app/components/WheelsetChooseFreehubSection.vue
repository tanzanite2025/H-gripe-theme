    ...
    <div class="rounded-2xl bg-[var(--tz-card-surface)] shadow-md p-5 md:p-6 hover:translate-y-[-2px] transition-transform duration-300">
       ...
       <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
          <div class="bg-emerald-50 rounded-xl p-3 border border-emerald-200">
              ...
              />
              <strong class="block text-emerald-600 text-sm mb-1 text-center">Micro Spline (MS)</strong>
               <p class="text-xs tz-text-muted text-center">Deore M6100, XT M8100, XTR M9100</p>
          </div>
          <div class="bg-emerald-50 rounded-xl p-3 border border-emerald-200">
              <GuideImage
                ...
                class="rounded-lg mb-2"
              />
              <strong class="block text-emerald-600 text-sm mb-1 text-center">HG Road (HG-11)</strong>
               <p class="text-xs tz-text-muted text-center">105, Ultegra, Dura-Ace (8-12sp)</p>
          </div>
          <div class="bg-emerald-50 rounded-xl p-3 border border-emerald-200">
              <GuideImage
                ...
                class="rounded-lg mb-2"
              />
              <strong class="block text-emerald-600 text-sm mb-1 text-center">HG Mountain</strong>
               <p class="text-xs tz-text-muted text-center">Older MTB & Entry Road setups</p>
          </div>
       </div>

       <div class="tz-surface-panel rounded-xl p-4">
           <h4 class="text-xs font-bold tz-text-muted uppercase tracking-widest mb-3">Compatibility Cheatsheet</h4>
          <ul class="space-y-3">
             <li class="flex items-start gap-3 text-xs tz-text-secondary">
       ...
       <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
          <div class="bg-red-500/5 rounded-xl p-3 border border-red-500/10">
              ...
              <strong class="block text-red-400 text-sm mb-1 text-center">XD Driver</strong>
               <p class="text-xs tz-text-muted text-center">GX Eagle, X01, XX1 (10T start)</p>
          </div>
          <div class="bg-red-500/5 rounded-xl p-3 border border-red-500/10">
              <GuideImage
              ...
              <strong class="block text-red-400 text-sm mb-1 text-center">XDR Driver</strong>
               <p class="text-xs tz-text-muted text-center">Rival, Force, Red eTap AXS</p>
          </div>
       </div>
       ...
       <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
          <div class="bg-emerald-50 rounded-xl p-3 border border-emerald-200">
              <GuideImage
                ...
                class="rounded-lg mb-2"
              />
              <strong class="block text-emerald-600 text-sm mb-1 text-center">N3W</strong>
              <p class="text-xs tz-text-secondary text-center">Ekar 13sp (Backward compatible w/ adapter)</p>
          </div>
          <div class="bg-emerald-50 rounded-xl p-3 border border-emerald-200">
              <GuideImage
                ...
                class="rounded-lg mb-2"
              />
              <strong class="block text-emerald-600 text-sm mb-1 text-center">Classic (ED/CP)</strong>
              <p class="text-xs tz-text-secondary text-center">9/10/11/12 Speed Road</p>
          </div>
       </div>
    ...
    <div class="pt-6 border-t tz-border-subtle">
       ...
       <div class="overflow-x-auto rounded-xl shadow-md bg-[var(--tz-card-surface)]">
            ...
            <tbody class="divide-y divide-slate-200/50">
              <tr class="hover:tz-surface-panel transition-colors">
                <td class="px-4 py-3 font-medium tz-text-primary">MS (Micro Spline 12s)</td>
              ...
              <tr class="hover:tz-surface-panel transition-colors">
                <td class="px-4 py-3 font-medium tz-text-primary">HG 8s</td>
                <td class="px-4 py-3">Claris R2000, Altus M310, Acera M360</td>
                <td class="px-4 py-3">Entry-level Road/MTB (11-32T).</td>
              </tr>
              <tr class="hover:tz-surface-panel transition-colors">
                <td class="px-4 py-3 font-medium tz-text-primary">HG 9-11s</td>
       ...
       <div class="overflow-x-auto rounded-xl shadow-md bg-[var(--tz-card-surface)]">
            ...
            <tbody class="divide-y divide-slate-200/50">
              <!-- Shimano -->
              <tr class="hover:tz-surface-panel transition-colors">
                 <td class="px-4 py-3 font-medium text-emerald-600">Shimano</td>
                 <td class="px-4 py-3">HG 8-11s MTB</td>
                 <td class="px-4 py-3">8/9/11s MTB</td>
                 <td class="px-4 py-3 text-emerald-600">No</td>
              </tr>
              <tr class="hover:tz-surface-panel transition-colors">
                 <td class="px-4 py-3 font-medium text-emerald-600">Shimano</td>
                 <td class="px-4 py-3">HG 8-11s MTB</td>
              ...
              <!-- Campy -->
               <tr class="hover:tz-surface-panel transition-colors">
                 <td class="px-4 py-3 font-medium text-emerald-600">Campagnolo</td>
