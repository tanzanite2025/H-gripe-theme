<template>
  <div class="flex flex-col h-full min-h-0">
    ...
    >
      <!-- 空状态 -->
      <div v-if="messages.length === 0" class="flex flex-col items-center justify-center h-full text-white/50 text-sm">
        <svg class="w-12 h-12 md:w-16 md:h-16 mb-2 md:mb-4 text-white/30" fill="none" stroke="currentColor" viewBox="0 0 24 24">
