  ...
  <div class="inner-tube-guide space-y-5 md:space-y-6">
    <!-- Step 1: Search / Intro Card -->
     <div class="rounded-2xl bg-[var(--tz-card-surface)] shadow-[0_8px_30px_rgba(0,0,0,0.6)] p-4 md:p-5">
       ...
       <div class="flex justify-center md:justify-end">
         <button
          type="button"
          class="inline-flex items-center justify-center rounded-full bg-[var(--tz-card-surface)] border border-[rgba(255,255,255,0.1)] px-7 py-2.5 text-xs font-bold uppercase tracking-wider tz-text-primary shadow-[0_4px_14px_rgba(0,0,0,0.45)] hover:border-[rgba(181,255,109,0.28)] hover:bg-white/[0.03] hover:text-[var(--tz-brand-primary)] transition-colors"
    ...
    <div class="rounded-2xl bg-[var(--tz-card-surface)] shadow-[0_8px_30px_rgba(0,0,0,0.6)] p-4 md:p-5 text-center">
       ...
       <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-5">
          <!-- AV -->
          <div class="rounded-xl bg-[var(--tz-card-surface)] p-3 shadow-[0_4px_16px_rgba(0,0,0,0.45)] flex flex-col items-center border border-[rgba(255,255,255,0.08)]">
       ...
       <div class="grid gap-5 lg:grid-cols-[minmax(0,0.95fr)_minmax(0,1.05fr)] lg:items-start">
        ...
        <div class="overflow-x-auto rounded-xl bg-[var(--tz-card-surface)] shadow-[0_4px_16px_rgba(0,0,0,0.45)] inline-block w-full border border-[rgba(255,255,255,0.08)]">
    ...
    <!-- Step 3: Tube Type Selection -->
     <div class="rounded-2xl bg-[var(--tz-card-surface)] shadow-[0_8px_30px_rgba(0,0,0,0.6)] p-4 md:p-5 text-center">
       ...
       <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          <!-- Standard -->
          <div class="rounded-xl bg-[var(--tz-card-surface)] p-3 shadow-[0_4px_16px_rgba(0,0,0,0.45)] border border-[rgba(255,255,255,0.08)] hover:bg-white/[0.03] transition-colors">
