...
<div class="relative space-y-8 before:absolute before:inset-0 before:ml-5 before:h-full before:w-0.5 before:-translate-x-px before:bg-slate-300 md:before:mx-auto md:before:translate-x-0">
      ...
      <div class="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group is-active">
         <!-- Icon/Marker -->
         <div class="flex items-center justify-center w-10 h-10 rounded-full border-4 border-[var(--tz-card-surface)] tz-surface-panel tz-text-secondary shadow shrink-0 md:order-1 md:group-odd:-translate-x-1/2 md:group-even:translate-x-1/2">
         ...
         <div class="w-[calc(100%-4rem)] md:w-[calc(50%-2.5rem)] rounded-2xl bg-[var(--tz-card-surface)] shadow-md p-5 md:p-6 p-6">
             ...
             <div class="tz-text-secondary text-sm leading-relaxed space-y-4">
               <ul class="space-y-4 list-none pl-0">
                 <li class="flex gap-2">
                   <span class="text-emerald-600 shrink-0">1.</span>
                   <span>Inspect all components to ensure they are intact (rim, hub, spokes, nipples).</span>
                 </li>
                 <li class="flex gap-2">
                   <span class="text-emerald-600 shrink-0">2.</span>
                   <span>We use our self‑developed semi‑automatic wheel truing stand, which allows centering adjustments without the need for a dishing tool, together with the Xieda spoke tension meter and several other tools we have designed ourselves.</span>
                 </li>
               </ul>
               ...
               <div class="grid grid-cols-2 gap-3 mt-4">
                  <GuideImage
                    ...
                    src="/testreport/wheelsetassembly/0/wheelsbuild-wheel-truing-stand-and-wheel-building-jig.webp"
                    alt="Self-developed wheel truing stand"
                    :zoomOnClick="true"
                    caption="Truing Stand"
                  />
                  <GuideImage
                    class="rounded-lg overflow-hidden shadow-md aspect-square object-cover"
                    src="/testreport/wheelsetassembly/0/wheel-building-tools.webp"
                    alt="Wheel building tools"
                    :zoomOnClick="true"
      ...
      <div class="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group is-active">
         <!-- Icon/Marker -->
         <div class="flex items-center justify-center w-10 h-10 rounded-full border-4 border-[var(--tz-card-surface)] bg-emerald-500 tz-text-primary shadow shrink-0 md:order-1 md:group-odd:-translate-x-1/2 md:group-even:translate-x-1/2">
         ...
         <div class="w-[calc(100%-4rem)] md:w-[calc(50%-2.5rem)] rounded-2xl bg-[var(--tz-card-surface)] shadow-md p-5 md:p-6 p-6">
             ...
             <div class="tz-text-secondary text-sm leading-relaxed space-y-4">
               <ul class="space-y-3 list-disc pl-4 marker:text-emerald-600">
         ...
         <div class="w-[calc(100%-4rem)] md:w-[calc(50%-2.5rem)] rounded-2xl bg-[var(--tz-card-surface)] shadow-md p-5 md:p-6 p-6">
             ...
             <div class="tz-text-secondary text-sm leading-relaxed space-y-4">
               <ul class="space-y-3 list-disc pl-4 marker:text-emerald-600">
                 ...
                 <li>
                    Ensure all spokes are correctly seated in both the hub and rim, with the lacing pattern properly aligned.
                    <div class="mt-2 text-xs bg-emerald-50 p-2 rounded border border-emerald-200">
                        <strong class="text-emerald-700">J-bend spokes:</strong> follow SHIMANO's standard orientation for inside/outside placement.<br>
                        <strong class="text-emerald-700">Straight-pull spokes:</strong> the lacing is fixed and determined solely by hub design.
                    </div>
                 </li>
               </ul>
               ...
               <div class="grid grid-cols-2 gap-3 mt-4">
                  <GuideImage
                    class="rounded-lg overflow-hidden shadow-md aspect-square object-cover"
                    src="/testreport/wheelsetassembly/2/wheel-lacing.webp"
                    alt="Installing nipples"
                    :zoomOnClick="true"
                  />
                  <GuideImage
                    class="rounded-lg overflow-hidden shadow-md aspect-square object-cover"
                    src="/testreport/wheelsetassembly/2/wheel-lacing-end.webp"
                    alt="Finished nipple installation"
                    :zoomOnClick="true"
                  />
               </div>
            </div>
         ...
         <div class="w-[calc(100%-4rem)] md:w-[calc(50%-2.5rem)] rounded-2xl bg-[var(--tz-card-surface)] shadow-md p-5 md:p-6 p-6">
             ...
             <div class="tz-text-secondary text-sm leading-relaxed space-y-4">
               ...
               <div class="grid grid-cols-2 gap-3 mt-4">
                  <GuideImage
                    class="rounded-lg overflow-hidden shadow-md aspect-square object-cover"
                    src="/testreport/wheelsetassembly/3/tighten-the-spoke-nipples.webp"
                    alt="Tightening nipples"
                    :zoomOnClick="true"
                  />
                  <GuideImage
                    class="rounded-lg overflow-hidden shadow-md aspect-square object-cover"
                    src="/testreport/wheelsetassembly/3/measure-spoke-tension.webp"
                    alt="Measuring spoke tension"
                    :zoomOnClick="true"
                  />
               </div>
            </div>
         ...
         <div class="w-[calc(100%-4rem)] md:w-[calc(50%-2.5rem)] rounded-2xl bg-[var(--tz-card-surface)] shadow-md p-5 md:p-6 p-6">
             ...
             <div class="tz-text-secondary text-sm leading-relaxed space-y-4">
               <ul class="space-y-3 list-disc pl-4 marker:text-emerald-600">
                 ...
                 <li>Check the dish (rim centering relative to the hub) to ensure proper alignment.</li>
               </ul>

               <div class="grid grid-cols-2 gap-3 mt-4">
                  <GuideImage
                    class="rounded-lg overflow-hidden shadow-md aspect-square object-cover"
                    src="/testreport/wheelsetassembly/4/self‑developed-wheel-building-equipment.webp"
                    alt="Self-developed wheel building equipment"
                    :zoomOnClick="true"
                  />
                  <GuideImage
                    class="rounded-lg overflow-hidden shadow-md aspect-square object-cover"
                    src="/testreport/wheelsetassembly/4/wheelsbuilding-and-check-spoke-tension.webp"
                    alt="Truing and checking tension"
                    :zoomOnClick="true"
                  />
               </div>
            </div>
         ...
         <div class="w-[calc(100%-4rem)] md:w-[calc(50%-2.5rem)] rounded-2xl bg-[var(--tz-card-surface)] shadow-md p-5 md:p-6 p-6">
             ...
             <div class="tz-text-secondary text-sm leading-relaxed space-y-4">
               <ul class="space-y-3 list-disc pl-4 marker:text-emerald-600">
                 ...
                 <li>Install rim tape and, if required, mount the tire.</li>
               </ul>
               <div class="flex items-center justify-center gap-2 text-emerald-600 font-bold mt-2">
                  <span>✓</span> <span>Process Complete</span>
               </div>

               <div class="grid grid-cols-2 gap-3 mt-4">
                  <GuideImage
                    class="rounded-lg overflow-hidden shadow-md aspect-square object-cover"
                    src="/testreport/wheelsetassembly/6/tubeless-rim-tape.webp"
                    alt="Tubeless rim tape installation"
                    :zoomOnClick="true"
                  />
                  <GuideImage
                    class="rounded-lg overflow-hidden shadow-md aspect-square object-cover"
                    src="/testreport/wheelsetassembly/6/wheelset-packaging.webp"
                    alt="Final packaging"
                    :zoomOnClick="true"
                  />
               </div>
