<template>
  <section id="returns" class="support-section">
    ...
    <div class="w-full max-w-none text-left space-y-10">
      ...
      <div>
         <h3 class="text-xl font-bold text-white mb-6 border-b border-white/10 pb-3">Return & Refund Conditions</h3>
         <div class="space-y-8">
            <!-- 1. Eligibility -->
      ...
      <!-- Fees & Charges -->
      <div>
         <h3 class="text-xl font-bold text-white mb-6 border-b border-white/10 pb-3">Fees & Charges</h3>
         <p class="tz-text-secondary text-sm mb-6">All costs related to returns are the responsibility of the customer, including:</p>
         <div class="space-y-8">
            <!-- 1. Restocking Fee -->
            <div class="relative pl-12">
              <div class="absolute left-0 top-0 w-8 h-8 rounded-full bg-slate-800 border border-slate-600 flex items-center justify-center text-slate-300 font-bold text-sm shadow-lg shadow-black/50">1</div>
              <h4 class="text-slate-100 font-bold text-lg mb-2 pt-0.5">Restocking & Refurbishment Fee</h4>
              <p class="tz-text-secondary text-sm leading-relaxed">
                Charged at <strong class="text-white bg-white/5 px-1.5 py-0.5 rounded text-xs font-bold border border-white/10">20% of the original purchase value (minimum USD $100)</strong>.
              </p>
            </div>
            ...
            <div class="relative pl-12">
              <div class="absolute left-0 top-0 w-8 h-8 rounded-full bg-slate-800 border border-slate-600 flex items-center justify-center text-slate-300 font-bold text-sm shadow-lg shadow-black/50">2</div>
              <h4 class="text-slate-100 font-bold text-lg mb-2 pt-0.5">Other Costs</h4>
              <p class="tz-text-secondary text-sm leading-relaxed">
                Unless otherwise specified under the warranty policy, shipping fees, duties, taxes, and any additional charges are borne by the customer.
              </p>
            </div>
         </div>
      </div>
