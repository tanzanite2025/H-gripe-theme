<template>
  <section class="fitment-catalog-lookup-panel" :aria-label="t('fitmentCatalog.tabs.fork')">
...
import { useFitmentForkLookup } from '~/composables/fitment-catalog/useFitmentForkLookup'
...
.fitment-catalog-lookup-panel__spinner {
  animation: fitment-fork-lookup-spin 900ms linear infinite;
}
...
@keyframes fitment-fork-lookup-spin {
  to {
