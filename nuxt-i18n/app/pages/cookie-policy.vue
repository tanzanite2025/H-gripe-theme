<template>
  <div class="min-h-screen bg-slate-950 text-slate-50 pt-24 pb-16 md:pt-28">
    <div class="max-w-4xl mx-auto px-4">
      <h1 class="text-2xl md:text-3xl font-semibold tracking-tight mb-4">
        Cookie Policy
      </h1>
      <p class="text-sm text-slate-400 mb-6">
        This page explains how Tanzanite uses cookies and similar technologies
      ...
      <div class="mt-4 space-y-8 text-slate-300">
        ...
        <!-- Managing Cookies -->
        <section>
          <h2 class="text-lg font-semibold text-white mb-3">Managing Your Cookie Preferences</h2>
          <p class="text-sm leading-relaxed mb-4">
            You can manage your cookie preferences at any time. Most web browsers allow you to 
        ...
        <!-- Third-Party Cookies -->
        <section>
          <h2 class="text-lg font-semibold text-white mb-3">Third-Party Cookies</h2>
          <p class="text-sm leading-relaxed">
