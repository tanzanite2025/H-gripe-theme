<!-- The profile page is a child of the /website route namespace. -->
<template>
...
definePageMeta({
  layout: 'products',
  footerLabelKey: 'footer.links.meThisWebsite',
  footerLabelFallback: 'Me & This Website',
})
