  ...
  <div>
    ...
    <section class="mt-6 grid gap-4 md:grid-cols-2 lg:gap-5">
      <NuxtLink
        ...
        :key="post.id"
        :to="localePath(`/resources/blog/wheelsbuild/${post.slug}`)"
...
const pageTitle = computed(() => t('blog.pages.wheelsbuild.title'))
const pageDescription = computed(() => t('blog.pages.wheelsbuild.intro'))
