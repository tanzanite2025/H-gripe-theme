...
export const membershipAndPointsTabs = [
  ...
  },
  {
    ...
    pageTitleKey: 'resourcesMembershipExchange.title',
    pageTitle: 'Gift Card Exchange',
    pageIntroKey: 'resourcesMembershipExchange.intro',
    pageIntro: 'Redeem eligible loyalty points for gift cards and track redeemed cards from your member center.',
    seoTitleKey: 'resourcesMembershipExchange.seoTitle',
    seoTitle: 'Gift Card Exchange - Redeem Loyalty Points',
    seoDescriptionKey: 'resourcesMembershipExchange.seoDescription',
    ...
    feedbackTitleKey: 'resourcesMembershipExchange.feedbackTitle',
    feedbackTitle: 'Share your feedback about gift card exchange',
    feedbackSubtitleKey: 'resourcesMembershipExchange.feedbackSubtitle',
