...
// Item is one configurable visual tile used by a storefront showcase.
type Item struct {
	ID              uint           `gorm:"primarykey" json:"id"`
	ShowcaseKey     string         `gorm:"not null;index:idx_visual_showcase_scope,priority:1" json:"showcase_key"`
