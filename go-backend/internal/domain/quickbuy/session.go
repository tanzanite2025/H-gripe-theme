...
type Session struct {
	...
	SubtotalSnapshotMinor int64          `gorm:"column:subtotal_snapshot_minor;not null;default:0" json:"subtotal_snapshot_minor"`
...
type SessionItem struct {
	...
	UnitPriceSnapshotMinor int64          `gorm:"column:unit_price_snapshot_minor;not null;default:0" json:"unit_price_snapshot_minor"`
