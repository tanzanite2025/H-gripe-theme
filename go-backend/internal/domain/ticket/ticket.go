...
type Ticket struct {
	...
	StatusVersion                  uint            `gorm:"not null;default:1" json:"-"`
	...
	CustomerServiceUnreadCount     int             `gorm:"column:customer_service_unread_count;->;-:migration" json:"-"`
	CustomerServiceInboxArchivedAt *time.Time      `gorm:"column:customer_service_inbox_archived_at;->;-:migration" json:"-"`
