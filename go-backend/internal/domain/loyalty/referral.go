...
type Referral struct {
	...
	ReferrerPoints   int            `gorm:"default:0" json:"referrer_points"`
	ReferredPoints   int            `gorm:"default:0" json:"referred_points"`
	CompletedOrderID uint           `gorm:"index" json:"completed_order_id"`
