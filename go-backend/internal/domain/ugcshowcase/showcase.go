...
// UGCShowcase is a buyer-submitted ride-wall record that flows through moderation.
type UGCShowcase struct {
...
func (UGCShowcase) TableName() string {
	return "showcases"
}

// UGCShowcaseComment is a public comment on a UGC showcase entry.
type UGCShowcaseComment struct {
	ID         uint   `gorm:"primaryKey;autoIncrement" json:"id"`
...
func (UGCShowcaseComment) TableName() string {
	return "comments"
}
