...
type Asset struct {
	...
	MimeType         string    `gorm:"type:varchar(120);not null;default:'image/webp'" json:"mime_type"`
	Size             int64     `gorm:"not null;default:0" json:"size"`
	ContentSHA256    string    `gorm:"type:char(64);not null;default:''" json:"content_sha256"`
	Width            int       `gorm:"not null;default:512" json:"width"`
	Height           int       `gorm:"not null;default:512" json:"height"`
	UploaderID       uint      `gorm:"not null;default:0" json:"uploader_id"`
	CreatedAt        time.Time `json:"created_at"`
	UpdatedAt        time.Time `json:"updated_at"`
}

func (Asset) TableName() string { return "site_favicon_assets" }
