...
func (h *UGCShowcaseHandler) Upload(c *gin.Context) {
	...
	identity := service.UGCShowcaseUploadProtectionIdentity{
		UserID:    userID,
	...
	decision, err := h.uploadProtection.Evaluate(c.Request.Context(), service.UGCShowcaseUploadProtectionInput{
		Identity:           identity,
