...
func (h *UGCShowcaseHandler) ServePublicImageFile(c *gin.Context) {
...
func (h *UGCShowcaseHandler) publicImageURL(id uint, imageIndex int) string {
...
func (h *UGCShowcaseHandler) AddComment(c *gin.Context) {
	var req struct {
...
func (h *UGCShowcaseHandler) ListComments(c *gin.Context) {
