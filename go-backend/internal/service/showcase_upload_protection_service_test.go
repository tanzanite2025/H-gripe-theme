...
func TestShowcaseUploadProtectionPendingLimitBlocksBeforeStore(t *testing.T) {
	...
	protection := &ShowcaseUploadProtectionService{
		store: store,
	...
	decision, err := protection.Evaluate(context.Background(), ShowcaseUploadProtectionInput{
		Identity:           ShowcaseUploadProtectionIdentity{UserID: 42, IPAddress: "203.0.113.10"},
...
func TestShowcaseUploadProtectionBlocksAfterUserWindowLimit(t *testing.T) {
	...
	input := ShowcaseUploadProtectionInput{
		Identity:    ShowcaseUploadProtectionIdentity{UserID: 42, IPAddress: "203.0.113.10"},
		UploadBytes: 1024,
	}
...
func TestShowcaseUploadProtectionKeysDoNotLeakRawIP(t *testing.T) {
	...
	if _, err := protection.Evaluate(context.Background(), ShowcaseUploadProtectionInput{
		Identity:    identity,
		UploadBytes: 1024,
	}); err != nil {
		t.Fatalf("Evaluate() error = %v", err)
...
func TestShowcaseUploadProtectionReturnsUnavailableWhenStoreFails(t *testing.T) {
	...
	_, err := protection.Evaluate(context.Background(), ShowcaseUploadProtectionInput{
		Identity:    ShowcaseUploadProtectionIdentity{UserID: 42, IPAddress: "203.0.113.10"},
		UploadBytes: 1024,
	})
	...
	err = protection.RecordFailure(context.Background(), ShowcaseUploadProtectionIdentity{UserID: 42, IPAddress: "203.0.113.10"})
	if !errors.Is(err, ErrShowcaseUploadProtectionUnavailable) {
...
func TestShowcaseUploadProtectionFailsClosedWhenRedisIsMissing(t *testing.T) {
	...
	protection := NewShowcaseUploadProtectionService(nil, cfg)
...
func newTestShowcaseUploadProtectionService(store showcaseUploadProtectionStore, overrides config.ShowcaseUploadProtectionConfig) *ShowcaseUploadProtectionService {
	cfg := config.ShowcaseUploadProtectionConfig{
		Enabled:                      true,
		WindowSeconds:                60,
