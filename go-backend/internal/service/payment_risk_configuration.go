...
func BuildPaymentRiskConfigurationView(
	...
	if threeDS != nil {
		...
		threeDSConfig = config.PaymentThreeDSConfig{
			...
			LowRiskMaxAmountMinor: threeDSConfigView.LowRiskMaxAmountMinor,
			AVSBillingShippingMismatchHighValueThresholdMinor: threeDSConfigView.AVSBillingShippingMismatchHighValueThresholdMinor,
	...
	return PaymentRiskConfigurationView{
		...
		ThreeDS: PaymentRiskThreeDSConfigurationView{
			...
			LowRiskMaxAmountMinor: threeDSConfig.LowRiskMaxAmountMinor,
			AVSBillingShippingMismatchHighValueThresholdMinor: threeDSConfig.AVSBillingShippingMismatchHighValueThresholdMinor,
