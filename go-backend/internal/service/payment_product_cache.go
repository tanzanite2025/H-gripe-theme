...
func (s *PaymentService) invalidateProductCacheAfterStockCommit(productIDs []uint) {
...
func (s *PaymentService) enqueueProductCacheInvalidationInTx(repos repository.TxRepositories, productIDs []uint, reason string) error {
