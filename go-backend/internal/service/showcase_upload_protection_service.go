...
const (
	ShowcaseUploadProtectionDecisionAllow = "allow"
	ShowcaseUploadProtectionDecisionBlock = "block"
)

type ShowcaseUploadProtectionIdentity struct {
	UserID    uint
	IPAddress string
}

type ShowcaseUploadProtectionInput struct {
	Identity           ShowcaseUploadProtectionIdentity
	UploadBytes        int64
	PendingSubmissions int64
}

type ShowcaseUploadProtectionDecision struct {
	Allowed    bool
	Action     string
	Dimension  string
	Count      int64
...
type ShowcaseUploadProtectionService struct {
...
func (s *ShowcaseUploadProtectionService) Evaluate(ctx context.Context, input ShowcaseUploadProtectionInput) (ShowcaseUploadProtectionDecision, error) {
	decision := ShowcaseUploadProtectionDecision{
		Allowed: true,
		Action:  ShowcaseUploadProtectionDecisionAllow,
	}
	if s == nil || !s.cfg.Enabled {
		return decision, nil
	}
	if input.PendingSubmissions >= int64(s.cfg.MaxPendingSubmissionsPerUser) {
		return ShowcaseUploadProtectionDecision{
			Allowed:   false,
			Action:    ShowcaseUploadProtectionDecisionBlock,
...
func (s *ShowcaseUploadProtectionService) RecordFailure(ctx context.Context, identity ShowcaseUploadProtectionIdentity) error {
	if s == nil || !s.cfg.Enabled {
		return nil
	}
	if s.unavailable || s.store == nil {
...
func (s *ShowcaseUploadProtectionService) evaluation(input ShowcaseUploadProtectionInput) showcaseUploadProtectionEvaluation {
...
func (s *ShowcaseUploadProtectionService) failure(identity ShowcaseUploadProtectionIdentity) showcaseUploadProtectionFailure {
