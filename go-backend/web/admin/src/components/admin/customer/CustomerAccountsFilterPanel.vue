<template>
  <AdminFilterPanel>
    <form class="grid grid-cols-1 gap-3 md:grid-cols-[minmax(240px,1.4fr)_minmax(150px,0.7fr)_auto]" @submit.prevent="emit('apply')">
...
import type { CustomerFilters } from '@/modules/customer/customerTypes'
...
const statusOptions: CustomerFilterOption[] = [
