...
export interface PaymentRiskMonitoringPolicy {
  window_days?: number | string
...
export interface PaymentRiskMonitoringConfiguration extends PaymentRiskMonitoringPolicy {
  worker_enabled?: boolean
  worker_interval_seconds?: number | string
}

export interface PaymentRiskConfiguration {
  monitoring?: PaymentRiskMonitoringConfiguration
  three_ds?: {
    enabled?: boolean
