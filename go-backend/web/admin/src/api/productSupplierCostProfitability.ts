...
import { productSupplierCostApi, type ProductSupplierCostRecord } from '@/api/productSupplierCost'
...
export interface ProfitabilitySupplierCostDetailsPayload {
...
export const productSupplierCostProfitabilityApi = {
  async listSupplierCostRecordsByCodes(codes: string[]): Promise<ProductSupplierCostRecord[]> {
    return productSupplierCostApi.listByCodes(codes)
  },
...
export default productSupplierCostProfitabilityApi
