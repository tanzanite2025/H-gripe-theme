...
WITH seed_pages(page_id, route_path, domain, title, subtitle, sort_order) AS (
    VALUES
        ...
        ('blog', '/blog', 'blog', 'Blog FAQs', 'Common questions about articles and buying guides', 500),
        ('blog-news', '/blog/news', 'blog', 'News FAQs', 'Common questions about news updates', 510),
        ('blog-wheelsbuild', '/blog/wheelsbuild', 'blog', 'Wheel Build FAQs', 'Common questions about wheel build articles and references', 520),
        ('company-about', '/company/about', 'company', 'About Us FAQs', 'Common questions about our factory and product philosophy', 405),
        ('policies', '/policies', 'policies', 'Policy FAQs', 'Common questions about store policies', 600),
        ...
        ('policies-refund-cancellation', '/policies/refund-cancellation', 'policies', 'Refund & Cancellation Policy FAQs', 'Common questions about refunds, cancellations, returns, and after-sales handling', 630),
