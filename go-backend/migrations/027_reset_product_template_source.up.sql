...
JOIN (
    VALUES
        ...
        ('rim', '规格', 'Brake Type', 'brake_type', 'select', '', FALSE, TRUE, TRUE, TRUE, 20, '[]'),
        ('rim', '规格', 'Tire Type', 'tire_type', 'select', '', FALSE, TRUE, TRUE, FALSE, 30, '[]'),
        ('rim', '规格', 'Wheel Size', 'wheel_size', 'text', '', FALSE, TRUE, TRUE, TRUE, 40, ''),
        ('rim', '规格', 'Rim Depth', 'rim_depth', 'number', 'mm', FALSE, FALSE, TRUE, FALSE, 50, ''),
        ('rim', '规格', 'Inner Width', 'inner_width', 'number', 'mm', FALSE, FALSE, TRUE, FALSE, 60, ''),
        ('rim', '规格', 'Outer Width', 'outer_width', 'number', 'mm', FALSE, FALSE, TRUE, FALSE, 70, ''),
        ('rim', '规格', 'Spoke Holes', 'spoke_holes', 'number', 'H', FALSE, FALSE, TRUE, TRUE, 80, ''),
        ('rim', '规格', 'ERD', 'erd', 'number', 'mm', FALSE, FALSE, TRUE, FALSE, 90, ''),

        ('carbon_frame', '规格', 'Material', 'material', 'select', '', FALSE, TRUE, TRUE, FALSE, 10, '[]'),
        ...
        ('carbon_frame', '规格', 'Brake Type', 'brake_type', 'select', '', FALSE, TRUE, TRUE, FALSE, 40, '[]'),
        ...
        ('wheelset', '规格', 'Material', 'material', 'select', '', FALSE, TRUE, TRUE, FALSE, 10, '[]'),
        ('wheelset', '规格', 'Brake Type', 'brake_type', 'select', '', FALSE, TRUE, TRUE, FALSE, 20, '[]'),
        ('wheelset', '规格', 'Tire Type', 'tire_type', 'select', '', FALSE, TRUE, TRUE, FALSE, 30, '[]'),
        ...
        ('handlebar', '规格', 'Material', 'material', 'select', '', FALSE, TRUE, TRUE, FALSE, 10, '[]'),
        ...
        ('handlebar', '规格', 'Cable Routing', 'cable_routing', 'select', '', FALSE, TRUE, TRUE, FALSE, 70, '[]'),
